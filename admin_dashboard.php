<?php
  ...
  if(isset($_POST['submit_attendance'])){
    if($_POST['food_type'] == 'Breakfast'){
      $query = "insert into attendance1(sno,id,attendance,date) values(null,$_POST[id],'$_POST[attendance]','$date')";
    }
    elseif($_POST['food_type'] == 'Lunch'){
      $query = "insert into attendance2(sno,id,attendance,date) values(null,$_POST[id],'$_POST[attendance]','$date')";
    }
    elseif($_POST['food_type'] == 'Snacks'){
      $query = "insert into attendance3(sno,id,attendance,date) values(null,$_POST[id],'$_POST[attendance]','$date')";
    }
    else{
      $query = "insert into attendance4(sno,id,attendance,date) values(null,$_POST[id],'$_POST[attendance]','$date')";
    }
